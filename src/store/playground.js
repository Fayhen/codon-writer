// Just a playground file to figure out the best data structures

const classicGenetics = {
  a: {
    name: "Alanine",
    abbreviation: "Ala",
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/9/90/L-Alanin_-_L-Alanine.svg",
  ...
  c: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/1/1a/L-Cystein_-_L-Cysteine.svg",
  ...
  d: {
    ...
    skeleton: "https://en.wikipedia.org/wiki/File:L-Asparagins%C3%A4ure_-_L-Aspartic_acid.svg",
  ...
  e: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/d/db/L-Glutamins%C3%A4ure_-_L-Glutamic_acid.svg",
  ...
  f: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/7/7a/L-Phenylalanin_-_L-Phenylalanine.svg",
  ...
  g: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/3/3f/Glycine-2D-skeletal.png",
  ...
  h: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/c/c0/L-Histidine_physiological.svg",
  ...
  i: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/4/46/L-Isoleucin_-_L-Isoleucine.svg",
  ...
  k: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/8/88/L-Lysin_-_L-Lysine.svg",
  ...
  l: {
    ...
    htmlFormula: "C<sub>6</sub>H<sub>13</sub>NO<sub>2</sub>",
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/4/4d/L-Leucine.svg",
  ...
  m: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/2/23/Methionin_-_Methionine.svg",
  ...
  n: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/0/0c/L-Asparagin_-_L-Asparagine.svg",
  ...
  p: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/f/ff/Prolin_-_Proline.svg",
  ...
  q: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/5/5d/L-Glutamin_-_L-Glutamine.svg",
  ...
  r: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/f/f4/Arginin_-_Arginine.svg",
  ...
  s: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/b/b9/L-Serin_-_L-Serine.svg",
  ...
  t: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/a/a0/L-Threonin_-_L-Threonine.svg",
  ...
  v: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/3/3d/L-valine-2D-skeletal.png",
  ...
  w: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/c/c1/L-Tryptophan_-_L-Tryptophan.svg",
  ...
  y: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/4/40/L-Tyrosin_-_L-Tyrosine.svg",
    pubchem: "https://pubchem.ncbi.nlm.nih.gov/compound/6057",
    wikipedia: "https://en.wikipedia.org/wiki/Tyrosine"
  }
}

const selenocysteine = {
  u: {
    name: "Selenocysteine",
    abbreviation: "Sec",
...
const pyrrolysine = {
  o: {
    ...
    skeleton: "https://upload.wikimedia.org/wikipedia/commons/7/71/Pyrrolysine.svg",
...
const classicStopCodons = ["UAA", "UGA", "UAG"]
const remainingStopCodons = ["UAA"]
